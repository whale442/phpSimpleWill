      ...
      //   var j = $('table tbody tr input #person_moreAccountNumber_'+ i).length;
       ...
       //  console.log("0: "+ $('#person_moreBank_' + i).val());
        ...
        var newElement = '<tr>'+
                             '<td>'+
                                 '<div class="book_date">'+
                                    '<select id="country1" name="person_bankName[]"  class="person_bankName frm-field required sect" style="height:30px;  border-radius:0px">'+
...
*/
    ...
    */
    var banklist = $('#bankDetails').find('select.person_bankName').map(function() {
         return $(this).val();
       }).get();
